...
describe("action routes", () => {
    test("when the user does not have a digipet, action routes direct them to hatch a digipet and do not call their relevant controllers", () => __awaiter(void 0, void 0, void 0, function* () {
        const routesAndControllers = {
            ...
            "/digipet/ignore": controller_1.ignoreDigipet,
        };
    ...
    describe("GET /digipet/ignore", () => {
        test("if the user has a digipet, it responds with a message about the ignore", () => __awaiter(void 0, void 0, void 0, function* () {
            // setup: reset digipet
            model_1.setDigipet(model_1.INITIAL_DIGIPET);
    ...
    describe("GET /digipet/rehome", () => {
        test("if the user has a digipet (and hasn't already rehomed), it responds with a message about the rehome", () => __awaiter(void 0, void 0, void 0, function* () {
            // setup: reset digipet
            model_1.setDigipet(model_1.INITIAL_DIGIPET);
        ...
        it("delegates state change to the rehomeDigipet function", () => __awaiter(void 0, void 0, void 0, function* () {
            // setup: reset digipet and mock function
            model_1.setDigipet(model_1.INITIAL_DIGIPET);
            if (jest.isMockFunction(controller_1.rehomeDigipet) /* type guard */) {
                controller_1.rehomeDigipet.mockReset();
            }
            // act
